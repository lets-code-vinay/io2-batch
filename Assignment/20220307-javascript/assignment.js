...
/**
 * 10. The length(height) and breadth of any triangle entered through the keyboard.
 * Write a program to find if the area of triangle is greater then perimeter of rectangle
 */

/**
 * 11. Given a point (x,y) write a program to find out if it lies on the x-axis, Y-axis or on the origin
 */
